...
const Landing: Component = () => {
  const { session, profile, loading, signInWithGoogle, signInWithApple, signInWithEmail, signUpWithEmail } = useAuth();
    ...
    <div class="landing">
      <div class="landing-content">
        ...
        <div class="landing-bottom">
          <button class="landing-cta landing-cta-apple" onClick={signInWithApple}>
